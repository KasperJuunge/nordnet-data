...
def login_nordnet():
    """ This function logs into Nordnet.dk . It requires that username and password
...
def get_transactions(startdate='2020-06-11'):
    """ Download transactions from Nordnet depot.
    Args:
...
def get_share_prices(sharelist, startdate='2013-01-01') :
